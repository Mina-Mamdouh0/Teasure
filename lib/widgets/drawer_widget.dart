// ignore_for_file: use_key_in_widget_constructors, unused_local_variable, constant_identifier_names, library_private_types_in_public_api
          ...
          AnimatedBuilder(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.white10.withAlpha(10), blurRadius: 0)
                ],
              ),
            ),
          ),
          ...
          AnimatedBuilder(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.white10.withAlpha(15), blurRadius: 0)
                ],
              ),
            ),
          )
